...
exports.getCurrentDayTimeAsYYYYMMDDHHmmss = exports.getCurrentDayAsYYYYMMDD = exports.convertDateToYYYYMMDD = exports.convertDateByType = exports.convertMinutesToDayHourMinute = void 0;
var moment_1 = __importDefault(require("moment"));
exports.convertMinutesToDayHourMinute = function (minutes) {
    var days = Math.floor(minutes / (60 * 24));
    var hours = days ? Math.floor((minutes - days * 60 * 24) / 60) : Math.floor(minutes / 60);
...
exports.getCurrentDayTimeAsYYYYMMDDHHmmss = function () {
